...
const SUPABASE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRuanJncGxkY3djcG95d2Ftb3JyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4NDExMDAwNiwiZXhwIjoy05OTY4NjAwNn0.dummy';
...
- **Quórum de Aprovacão**: Exige a concordância de **2/3 dos membros do STF** (pelo menos 8 Ministros).
...
async function seed() {
  ...
  // Insere via REST Supabase com chave anon/service
  const response = await fetch(`${SUPABASE_URL}/rest/v1/blog_edicao_posts`, {
    method: 'POST',
    headers: {
      'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRuanJncGxkY3djcG95d2Ftb3JyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQxMTAwMDYsImV4cCI6MjA5OTY4NjAwNn0.6NstK0_f3p8i_Sj3-1_YgK5o1hU1Z9S0Z0k1r2s3t4u',
      'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRuanJncGxkY3djcG95d2Ftb3JyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQxMTAwMDYsImV4cCI6MjA5OTY4NjAwNn0.6NstK0_f3p8i_Sj3-1_YgK5o1hU1Z9S0Z0k1r2s3t4u',
