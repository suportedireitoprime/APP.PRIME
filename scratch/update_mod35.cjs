...
async function updateModuleInteractiveSlides(sheetNum) {
  ...
  console.log(`\nUpdating Module ${sheetNum} (${s.name}) - ${aulasRows.length} aulas...`);
  ...
  console.log(`Module ${sheetNum} updated successfully.`);
}

async function run() {
  console.log('Testing update on Module 35...');
  await updateModuleInteractiveSlides(35);
  console.log('Done test update on Module 35.');
}
