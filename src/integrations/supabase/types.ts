  ...
  public: {
    Tables: {
      ...
      audioaulas_itens: {
        ...
        Relationships: [
          {
            foreignKeyName: "audioaulas_itens_curso_id_fkey"
            columns: ["curso_id"]
            isOneToOne: false
            referencedRelation: "audioaulas_cursos"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      biblioteca_leitura_fila_estado: {
        Row: {
          atualizado_em: string
          escopo: string
          rodando: boolean
      ...
      biblioteca_leitura_nativa: {
        Row: {
          ...
          conteudo_md_refinado_url: string | null
          conteudo_md_url: string | null
          created_at: string
      ...
      boletim_config: {
        Row: {
          ...
          id: number
          legislativo_ativo: boolean | null
          legislativo_horario: string | null
          legislativo_max_itens: number | null
          legislativo_prompt_tts_extra: string | null
          legislativo_voz_id: string | null
          max_normas: number
      ...
      flashcards_deck_itens: {
        ...
        Relationships: [
          {
            foreignKeyName: "flashcards_deck_itens_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "flashcards_deck_itens_deck_id_fkey"
            columns: ["deck_id"]
            isOneToOne: false
            referencedRelation: "flashcards_decks"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      flashcards_progresso: {
        ...
        Relationships: [
          {
            foreignKeyName: "flashcards_progresso_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "flashcards_cards"
            referencedColumns: ["id"]
      ...
      forca_artigos_cache: {
        ...
        Relationships: [
          {
            foreignKeyName: "forca_artigos_cache_artigo_id_fkey"
            columns: ["artigo_id"]
            isOneToOne: true
      ...
      forca_artigos_progresso: {
        ...
        Relationships: [
          {
            foreignKeyName: "forca_artigos_progresso_artigo_id_fkey"
            columns: ["artigo_id"]
            isOneToOne: false
            referencedRelation: "vade_mecum_artigos"
            referencedColumns: ["id"]
      ...
      lei_seca_lembretes: {
        Row: {
          ...
          diario_hora: string
          retomada_ativa: boolean
          ultima_trilha: string | null
          updated_at: string
          user_id: string
        }
        Insert: {
      ...
      leis_cantadas_reacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "leis_cantadas_reacoes_lei_cantada_id_fkey"
            columns: ["lei_cantada_id"]
            isOneToOne: false
      ...
      leis_cantadas_stats: {
        ...
        Relationships: [
          {
            foreignKeyName: "leis_cantadas_stats_lei_cantada_id_fkey"
            columns: ["lei_cantada_id"]
            isOneToOne: true
            referencedRelation: "leis_cantadas"
            referencedColumns: ["id"]
      ...
      pilulas_cards: {
        ...
        Relationships: [
          {
            foreignKeyName: "pilulas_cards_deck_id_fkey"
            columns: ["deck_id"]
            isOneToOne: false
            referencedRelation: "pilulas_decks"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      play_reviews: {
        Row: {
          ...
          reply_last_modified_at: string | null
      ...
      questoes: {
        Row: {
          ...
          comentario_ia_gerado_em: string | null
          created_at: string
        ...
        Relationships: [
          {
            ...
            columns: ["cargo_id"]
            isOneToOne: false
            referencedRelation: "questoes_cargos"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "questoes_planilha_id_fkey"
            columns: ["planilha_id"]
            isOneToOne: false
            referencedRelation: "questoes_planilhas"
            referencedColumns: ["id"]
          },
        ]
      }
      questoes_acoes_cache: {
        Row: {
          chave: string
          created_at: string
          id: string
      ...
      questoes_desafios_progresso: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_desafios_progresso_desafio_id_fkey"
            columns: ["desafio_id"]
            isOneToOne: false
            referencedRelation: "questoes_desafios"
            referencedColumns: ["id"]
          },
        ]
      }
      questoes_favoritos: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_favoritos_questao_id_fkey"
            columns: ["questao_id"]
            isOneToOne: false
      ...
      questoes_planilhas: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_planilhas_cargo_id_fkey"
            columns: ["cargo_id"]
            isOneToOne: false
            referencedRelation: "questoes_cargos"
            referencedColumns: ["id"]
      ...
      questoes_respostas: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_respostas_questao_id_fkey"
            columns: ["questao_id"]
            isOneToOne: false
            referencedRelation: "questoes"
            referencedColumns: ["id"]
      ...
      questoes_simulado_itens: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_simulado_itens_questao_id_fkey"
            columns: ["questao_id"]
            isOneToOne: false
            referencedRelation: "questoes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "questoes_simulado_itens_simulado_id_fkey"
            columns: ["simulado_id"]
            isOneToOne: false
            referencedRelation: "questoes_simulados"
            referencedColumns: ["id"]
          },
        ]
      }
      questoes_simulados: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_simulados_cargo_id_fkey"
            columns: ["cargo_id"]
            isOneToOne: false
            referencedRelation: "questoes_cargos"
            referencedColumns: ["id"]
      ...
      questoes_sync_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_sync_log_planilha_id_fkey"
            columns: ["planilha_id"]
            isOneToOne: false
            referencedRelation: "questoes_planilhas"
            referencedColumns: ["id"]
      ...
      questoes_trilha_progresso: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_trilha_progresso_trilha_id_fkey"
            columns: ["trilha_id"]
            isOneToOne: false
            referencedRelation: "questoes_trilhas"
            referencedColumns: ["id"]
          },
        ]
      }
      questoes_trilhas: {
        ...
        Relationships: [
          {
            foreignKeyName: "questoes_trilhas_cargo_id_fkey"
            columns: ["cargo_id"]
            isOneToOne: false
            referencedRelation: "questoes_cargos"
            referencedColumns: ["id"]
      ...
      radar_stf_pautas: {
        ...
        Relationships: [
          {
            foreignKeyName: "radar_stf_pautas_relator_id_fkey"
            columns: ["relator_id"]
            isOneToOne: false
            referencedRelation: "radar_stf_ministros"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      resumo_metodologias: {
        ...
        Relationships: [
          {
            foreignKeyName: "resumo_metodologias_resumo_id_fkey"
            columns: ["resumo_id"]
            isOneToOne: false
            referencedRelation: "resumos_juridicos"
            referencedColumns: ["id"]
      ...
      stf_ministros: {
        Row: {
          artigos_revistas: string | null
          biografia: string | null
          created_at: string
          curriculo: string | null
          dados_e_datas: Json | null
          data_fim: string | null
          data_indicacao: string | null
          data_nascimento: string | null
          datas_historicas: string | null
      ...
      stf_session_agendas: {
        ...
        Relationships: [
          {
            foreignKeyName: "stf_session_agendas_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "stf_sessions"
            referencedColumns: ["id"]
          },
        ]
      }
      stf_sessions: {
        Row: {
          ...
          id: string
          scheduled_at: string
          status: Database["public"]["Enums"]["stf_session_status"]
          title: string
          updated_at: string | null
          youtube_video_id: string | null
        }
      ...
      vademecum_historico_alteracoes: {
        Row: {
          artigos_afetados: string[]
          criado_em: string | null
          data_alteracao: string | null
          id: string
          lei_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "vademecum_historico_alteracoes_lei_id_fkey"
            columns: ["lei_id"]
            isOneToOne: false
            referencedRelation: "vade_mecum_leis"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      admin_deploy_boletim_crons: {
        Args: { anon_key: string; crons_json: string }
        Returns: Json
      }
      ...
      alternar_curtida: { Args: { p_musica_id: string }; Returns: boolean }
      ...
      aprender_home_resumo: { Args: never; Returns: Json }
      ...
      flashcards_streak: { Args: never; Returns: number }
      flashcards_temas: {
        Args: { _area: string }
        Returns: {
          a_revisar: number
      ...
      increment_forca_stats: {
        Args: {
          p_highest_combo: number
          p_is_win: boolean
          p_user_id: string
          p_xp_gained: number
        }
      ...
      questoes_areas: {
        Args: { _cargo_id?: string; _nivel?: string }
        Returns: {
          area: string
          total: number
        }[]
      }
      questoes_desafio_status: {
        Args: never
        Returns: {
          area: string
          cor: string
      ...
      questoes_desempenho: { Args: never; Returns: Json }
      questoes_filtrar: {
        Args: {
          _anos?: number[]
          _assuntos?: string[]
      ...
      questoes_segmento: {
        Args: { _cargo: string; _nivel: string }
        Returns: string
      }
      questoes_sortear: {
        Args: {
      ...
      upsert_forca_article_stars: {
        Args: { p_artigo_id: string; p_stars: number; p_user_id: string }
        Returns: undefined
      }
    }
    Enums: {
      ...
      stf_session_status: "scheduled" | "live" | "finished" | "canceled"
    }
    CompositeTypes: {
      [_ in never]: never
    }
