...
export const SUMULA_TRIBUNAIS = [
  { id: 'STF_VINCULANTE', nome: 'Súmulas Vinculantes', tribunal: 'STF', descricao: 'Efeito vinculante para o Judiciário e Administração Pública', iconColor: '#a81f40', count: 63 },
