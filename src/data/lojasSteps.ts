  ...
  },
  {
    ...
    passos: [
      ...
      },
      {
        ...
        descricao: "Nomeie a chave (ex: 'Direito Prime CI/CD'), escolha 'App Manager', gere e baixe o .p8 IMEDIATAMENTE (só aparece uma vez).",
    ...
    passos: [
      {
        ...
        descricao: "Direito Prime só usa TLS/Keychain padrão do iOS, isento de documentação de export de criptografia (ERN). O workflow build-ios.yml já injeta essa flag automaticamente no Info.plist a cada build.",
