...
const MeuEspaco = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-background overflow-y-auto">
      ...
      <div className="lg:mx-auto lg:w-full lg:max-w-[1200px] lg:grid lg:grid-cols-2 lg:items-start lg:gap-6 lg:px-8">
      {/* Bio */}
      ...
      {/* Quick access */}
      <div className="px-5 mt-5 lg:px-0 lg:mt-5">
      ...
      <div className="px-5 mt-6 pb-[calc(4rem+var(--sai-bottom,env(safe-area-inset-bottom,0px)))] lg:col-span-2 lg:px-0">
