...
const Configuracoes = () => {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <div className="px-4 lg:px-8 py-6 max-w-lg lg:max-w-6xl mx-auto lg:grid lg:grid-cols-[minmax(0,1fr)_380px] lg:items-start lg:gap-10">
        <div>
        ...
        {/* Seções adicionais */}
        <div className="mt-8 lg:mt-0 space-y-2 lg:sticky lg:top-6">
          ...
          {[
            ...
            { to: '/sobre', icon: Info, label: 'Sobre o Direito Prime', desc: 'Versão, contato e feedback' },
