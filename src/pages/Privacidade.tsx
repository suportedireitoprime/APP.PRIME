        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              O <strong>Direito Prime</strong> é um
          ...
          <section>
            ...
            <p className="mb-3 text-muted-foreground leading-relaxed">
              Para funcionar, o Direito Prime integra os seguintes serviços. Cada um deles
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              O Direito Prime é destinado a estudantes de Direito e profissionais maiores de
