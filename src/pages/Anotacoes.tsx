...
const Anotacoes = () => {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      ...
      <main className="px-4 pt-4 lg:mx-auto lg:w-full lg:max-w-[1300px] lg:px-12 2xl:px-16 lg:pt-8">
        <div className="relative mb-4 lg:mb-6 lg:max-w-xl">
        ...
        {loading ? (
          ...
          <div className="space-y-3 lg:grid lg:grid-cols-2 lg:gap-4 lg:space-y-0 2xl:grid-cols-3">
            {filtered.map((n, i) => (
              <motion.div
                key={n.id}
