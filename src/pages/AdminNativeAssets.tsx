...
const AdminNativeAssets = () => {
  ...
  const [appName, setAppName] = useState<string>('Direito Prime');
  const [appNameSaved, setAppNameSaved] = useState<string>('Direito Prime');
  ...
  const saveAppName = async () => {
    const name = appName.trim() || 'Direito Prime';
    setAppNameBusy(true);
    setError(null);
    try {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                Aparece no launcher do Android e no iOS logo abaixo do ícone. Padrão: <b>Direito Prime</b>. Máx. 30 caracteres.
              </p>
