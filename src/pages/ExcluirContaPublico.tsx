...
export default function ExcluirContaPublico() {
  return (
    <main className="min-h-dvh bg-background text-foreground px-6 py-10 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Exclusão de conta — Direito Prime</h1>

      <p className="mb-4">
        Você pode solicitar a exclusão da sua conta Direito Prime e de todos os dados
      ...
      <ol className="list-decimal pl-6 space-y-2 mb-6">
        <li>Abra o app Direito Prime e faça login.</li>
      ...
      <p className="mb-2">
        ...
        <a className="underline" href="mailto:wn7corporation@gmail.com?subject=Exclus%C3%A3o%20de%20conta%20-%20Estudos%20Jur%C3%ADdicos">
          wn7corporation@gmail.com
        </a>{" "}
        a partir do endereço cadastrado, com o assunto{" "}
        <strong>&quot;Exclusão de conta Direito Prime&quot;</strong>. A exclusão é feita em até
        7 dias úteis.
      </p>
