...
const Newsletter = () => {
  ...
  const content = (
    <div className="max-w-xl mx-auto px-4 sm:px-6 py-6 pb-[calc(7rem+var(--sai-bottom))] lg:px-0 space-y-6">
      {/* Toggle ativo */}
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          readOnly
          disabled
          className="w-full px-4 py-2.5 rounded-xl bg-card/50 border border-border text-muted-foreground text-sm cursor-not-allowed focus:outline-none"
