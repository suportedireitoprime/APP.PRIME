  ...
  return (
    <DesktopPageLayout activeId="praticar" title={leiNome} subtitle="Trilha da lei" mobileHeader={header}>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg, hsl(350 70% 22%), hsl(0 84% 55%))' }}
      >
                  ...
                  <div
                    ...
                    style={
                      dominado
                        ...
                        : {
                            background: 'linear-gradient(135deg, hsl(350 70% 22%), hsl(0 84% 55%))',
                      ...
                      <div
                        ...
                        style={{
                          ...
                          background: dominado
                            ...
                            : 'linear-gradient(90deg, hsl(350 70% 22%), hsl(0 84% 55%))',
                        }}
                      />
                    </div>
                  </div>
...
const NIVEL_META: Record<NivelDominio, { label: string; color: string; bg: string }> = {
  ...
  mediano:   { label: 'Mediano',   color: 'hsl(0 92% 40%)',  bg: 'hsl(0 95% 92%)' },
  ...
  return (
    <div className="flex flex-col h-full min-h-0">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, hsl(350 70% 22%), hsl(0 84% 50%))' }}
      >
        <button
          type="button"
          onClick={onClose}
      ...
      <div className="shrink-0 border-t border-border bg-background/95 backdrop-blur px-4 py-3 pb-[max(0.75rem,var(--sai-bottom))]">
        <button
