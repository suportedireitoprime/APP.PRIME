...
export default function SuportePublico() {
  return (
    <main className="min-h-dvh bg-background text-foreground px-6 py-10 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold mb-3">Suporte — Direito Prime</h1>
      ...
      <section className="rounded-xl border border-border p-5 mb-6 bg-card">
        ...
        <p className="mb-2">
          ...
          <a
            ...
            href="mailto:wn7corporation@gmail.com?subject=Suporte%20Estudos%20Jur%C3%ADdicos"
          >
      ...
      <p className="text-xs text-muted-foreground mt-8 text-center">
        Direito Prime · WN7 Corporation · CNPJ 00.000.000/0001-00
      </p>
    </main>
  );
}