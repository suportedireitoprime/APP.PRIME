...
const Perfil = () => {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      ...
      <div className="px-4 lg:px-8 pt-2 pb-4 space-y-5 max-w-lg lg:max-w-6xl mx-auto lg:space-y-0 lg:grid lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start lg:gap-8">
