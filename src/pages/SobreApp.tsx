...
const SobreApp = () => {
  ...
  const abrirFeedback = () => {
    ...
    const subject = encodeURIComponent(`[Direito Prime v${APP_VERSION}] Feedback / Problema`);
    const body = encodeURIComponent(
      `Olá! Gostaria de compartilhar um feedback sobre o Direito Prime.\n\n---\nApp: Direito Prime ${APP_VERSION}\nPlataforma: ${platform}\n---\n\n(Escreva sua mensagem abaixo)\n\n`,
    );
      ...
      <div className="p-4 lg:px-8 space-y-6 max-w-lg lg:max-w-4xl mx-auto pb-16">
        ...
        <section className="space-y-2">
          <h3 className="font-display text-base font-bold text-foreground flex items-center gap-2">
            <Scale className="w-5 h-5 text-primary" /> O que é o Direito Prime?
          </h3>
          <p className="text-sm text-muted-foreground font-body leading-relaxed">
            O Direito Prime é uma plataforma jurídica completa, pensada para estudantes de Direito, concurseiros e profissionais da área.
        ...
        <section className="pt-4 border-t border-border text-center space-y-1">
          ...
          <p className="text-xs text-muted-foreground font-body">Direito Prime © 2026 — Todos os direitos reservados</p>
        </section>
      </div>
    </div>
  );
