    ...
    <div className="min-h-dvh bg-background pb-20">
      ...
      <div className="sticky top-0 z-30 bg-background/95 backdrop-blur-md border-b border-border">
        <ScrollArea className="w-full">
          <div className="flex gap-2 px-4 py-3 lg:mx-auto lg:max-w-[1500px] lg:px-12 2xl:px-16">
            {TIPO_FILTERS.map(t => (
              <button
                key={t}
      ...
      <main className="max-w-5xl mx-auto px-4 py-3 pb-[calc(7rem+var(--sai-bottom,env(safe-area-inset-bottom,0px)))] space-y-2.5 lg:max-w-[1500px] lg:px-12 lg:py-6 lg:grid lg:grid-cols-2 lg:gap-3 lg:space-y-0 2xl:grid-cols-3 2xl:px-16">
        {loading && (
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-12 space-y-3 lg:col-span-full">
