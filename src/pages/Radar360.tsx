...
export default function Radar360() {
  ...
  return (
    <div className="min-h-dvh bg-background pb-20">
      ...
      <main className="max-w-5xl mx-auto px-4 py-3 space-y-2.5 lg:max-w-[1500px] lg:px-12 lg:py-6 lg:grid lg:grid-cols-2 lg:gap-3 lg:space-y-0 2xl:grid-cols-3 2xl:px-16">
        {loading && (
