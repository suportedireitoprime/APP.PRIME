...
const EstudosHub = () => {
  ...
  return (
    <div className="min-h-dvh bg-background pb-24">
      ...
      <div className="px-4 pt-5 space-y-5 lg:mx-auto lg:w-full lg:max-w-[1400px] lg:px-12 lg:pt-8 lg:grid lg:grid-cols-2 lg:items-start lg:gap-6 lg:space-y-0 2xl:px-16">
        {/* Motivational Hero */}
        <motion.div
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary to-primary/80 p-5 text-primary-foreground lg:col-span-2"
        >
