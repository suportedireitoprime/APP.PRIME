...
const FlashcardsDesafios = () => {
  ...
  return (
    <div className="min-h-screen bg-background pb-32">
      <PageHeader title="Desafios" />

      <div className="mx-auto w-full max-w-2xl px-4">
        {/* Resumo do desafio ativo */}
        <div className="mt-3 rounded-2xl border border-primary/30 bg-primary/10 p-4">
          <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-primary">Seu desafio atual</p>
          {ativo ? (
            <>
              ...
              <button
                ...
                className="mt-3 flex h-12 w-full items-center justify-center rounded-xl bg-primary text-[14px] font-bold text-primary-foreground active:scale-[0.99]"
              >
                Continuar desafio
              </button>
            </>
