        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Ao criar uma conta e utilizar o aplicativo <strong>Direito Prime</strong>,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              O Direito Prime é uma plataforma digital de estudo jurídico que oferece
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              O Direito Prime oferece funcionalidades gratuitas e recursos premium com
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              O Direito Prime é fornecido "como está". Na máxima extensão permitida por lei,
