...
const COLORS = ['#f43f5e', '#f97316', '#a81f40', '#22c55e', '#06b6d4', '#8b5cf6', '#ec4899', '#14b8a6', '#6366f1', '#a855f7'];
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      {loading ? (
        ...
        <div className="p-4 space-y-5 lg:mx-auto lg:w-full lg:max-w-[1400px] lg:px-12 lg:py-8 2xl:px-16">
          {/* Profile card */}
