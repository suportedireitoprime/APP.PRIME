    ...
    <div className="space-y-3">
      {concursos.map(c => (
        <motion.button
          ...
          className="w-full flex items-center gap-4 text-left p-4 rounded-3xl border border-border/40 bg-card/60 backdrop-blur-md shadow-lg shadow-black/10 hover:border-primary/50 transition-all active:scale-[0.98]"
        >
