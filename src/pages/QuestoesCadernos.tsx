        ...
        <div className="px-4 py-5">
          ...
          <div className="rounded-2xl border border-border bg-card p-4">
            ...
            <input
              ...
              className="mt-3 h-11 w-full rounded-xl border border-border bg-background px-3 text-[14px] text-foreground outline-none placeholder:text-muted-foreground focus:border-primary/50"
            />
            <button
              onClick={() => {
              ...
              className="mt-3 flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-primary text-[15px] font-bold text-primary-foreground active:scale-[0.99]"
            >
            ...
            <div className="mt-3 space-y-3">
              ...
              {cadernos.map((c) => (
                <div key={c.id} className="flex items-center gap-3 rounded-2xl border border-border bg-card p-4">
                  ...
                  <button onClick={() => abrirCaderno(c.filtros)} className="min-w-0 flex-1 text-left">
                  ...
                  <button onClick={() => remover(c.id)} aria-label="Excluir caderno" className="p-2 text-muted-foreground">
