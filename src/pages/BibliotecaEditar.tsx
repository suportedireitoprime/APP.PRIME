    ...
    <div className="min-h-dvh bg-background pb-[calc(96px+var(--sai-bottom,0px))]">
      ...
      {step === 'colecoes' && (
        <div className="p-4 space-y-3 max-w-3xl mx-auto">
          <button
            type="button"
            onClick={() => navigate('/admin-leitura-nativa')}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="font-display font-bold text-foreground text-sm">Leitura Nativa (OCR + Gemini)</div>
              <div className="text-[11px] text-muted-foreground truncate">
                Extração individual ou em massa, fila e prévia
              </div>
            </div>
