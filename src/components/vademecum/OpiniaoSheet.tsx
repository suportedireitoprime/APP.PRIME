...
import { X, Camera, Send, Sparkles, MessageCircleWarning, Bug, HelpCircle, Loader2, CheckCircle2 } from 'lucide-react';
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-0 right-0 bottom-0 z-[1401] h-[90dvh] bg-card border-t border-border rounded-t-3xl flex flex-col shadow-2xl"
          >
            <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-border">
              <div className="w-10 h-1.5 rounded-full bg-muted absolute left-1/2 -translate-x-1/2 -top-3" />
              <div>
                <h2 className="font-display text-lg font-bold text-foreground">Sua opinião</h2>
                <p className="text-xs text-muted-foreground font-body">Conte o que achou, sugira, critique ou reporte</p>
              </div>
              <button
                onClick={handleClose}
