  ...
  return createPortal(
    <>
      ...
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 z-[10041] bg-card border-t border-border rounded-t-3xl pb-[calc(1rem+var(--sai-bottom))] h-[90dvh] flex flex-col overflow-hidden md:left-auto md:right-0 md:top-0 md:bottom-0 md:h-full md:max-h-none md:w-[min(30rem,92vw)] md:max-w-none md:rounded-none md:rounded-l-3xl md:border-l md:border-t-0 md:shadow-2xl md:mx-0"
      >
        {/* Cabeçalho fixo */}
