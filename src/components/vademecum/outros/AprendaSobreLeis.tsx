...
interface AprendaSobreLeisProps {
  /** Classe aplicada ao container do título/descrição para ajustar a margem lateral. */
  titleClassName?: string;
}

export default function AprendaSobreLeis({ titleClassName = 'px-1' }: AprendaSobreLeisProps) {
