...
import ShareSheet from '@/components/vademecum/sheets/ShareSheet';
                ...
                <motion.div
                  ...
                  className={
                    isDesktop
                      ...
                      : 'fixed inset-x-0 bottom-0 z-[60] mx-auto w-full md:max-w-[640px] rounded-t-3xl bg-card border-t border-border md:border-x flex flex-col max-h-[80vh]'
                  }
                >
