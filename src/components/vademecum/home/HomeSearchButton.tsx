...
const HomeSearchButton = ({ onOpenSearch }: HomeSearchButtonProps) => {
  ...
  return (
    ...
    >
      ...
      <div 
        aria-hidden="true"
        className="absolute right-1.5 top-1/2 -translate-y-1/2 h-11 sm:h-12 px-3.5 sm:px-4.5 rounded-xl bg-hero-panel text-white font-display text-[12px] sm:text-[13px] font-bold tracking-wider flex items-center justify-center shadow-md shadow-black/30 pointer-events-none select-none"
      >
        PESQUISAR
      </div>
    </button>
