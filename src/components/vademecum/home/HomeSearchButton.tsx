...
const HomeSearchButton = ({ onOpenSearch }: HomeSearchButtonProps) => {
  ...
  return (
    ...
    >
      ...
      <div 
        aria-hidden="true"
        className="absolute right-1.5 top-1/2 -translate-y-1/2 h-11 sm:h-12 px-4 sm:px-5 rounded-xl bg-gradient-to-tr from-[#3a0308] via-[#7a0816] to-[#b81829] text-white font-body text-[13px] sm:text-[14px] font-black tracking-widest flex items-center justify-center shadow-[0_4px_12px_rgba(155,17,30,0.4)] pointer-events-none select-none uppercase"
      >
        PESQUISAR
      </div>
    </button>
