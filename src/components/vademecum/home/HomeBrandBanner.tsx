...
const HomeBrandBanner = () => {
  return (
    <div className="flex flex-col items-center text-center gap-1 z-[10] relative w-[42%] max-w-[160px] ml-2 sm:ml-4">
      ...
      <h1 className="font-serif italic text-white text-[22px] sm:text-[24px] leading-[1.05] font-semibold tracking-tight drop-shadow-[0_2px_6px_rgba(0,0,0,0.55)] whitespace-nowrap">
        Estudos Jurídicos
      </h1>
