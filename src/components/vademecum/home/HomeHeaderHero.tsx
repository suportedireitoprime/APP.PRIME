...
import heroEstudanteImg from '@/assets/covers/hero-estudante-v2.jpg';
    ...
    <>
      ...
      >
        ...
        <img
          ...
          loading="eager"
          decoding="async"
          className="absolute inset-0 w-full h-full object-cover object-[25%_center] md:object-center z-0 pointer-events-none translate-x-[-2%]"
        />
