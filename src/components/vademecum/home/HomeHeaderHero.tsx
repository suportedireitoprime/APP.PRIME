    ...
    <>
      ...
      >
        ...
        <img
          ...
          loading="eager"
          decoding="async"
          className="absolute inset-0 w-full h-full object-cover object-[15%_center] md:object-center z-0 pointer-events-none scale-[0.85] translate-x-[8%] origin-right"
        />
