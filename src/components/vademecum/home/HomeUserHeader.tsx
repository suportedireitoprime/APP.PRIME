    ...
    <header className="relative z-10 px-3 pt-3 md:px-6 md:pt-4 lg:px-8 lg:pt-6 flex items-center gap-2 md:gap-4">
      ...
      <div className="flex items-center gap-2 md:gap-3 shrink-0">
        <button
          ...
          className="relative w-11 h-11 md:w-12 md:h-12 lg:w-13 lg:h-13 rounded-full bg-black/75 hover:bg-black/90 border border-primary/40 backdrop-blur-sm shadow-lg shadow-black/30 flex items-center justify-center active:scale-95 transition"
        >
        ...
        <button
          ...
          className="w-11 h-11 md:w-12 md:h-12 lg:w-13 lg:h-13 rounded-full bg-black/75 hover:bg-black/90 border border-primary/40 backdrop-blur-sm shadow-lg shadow-black/30 flex items-center justify-center active:scale-95 transition"
        >
