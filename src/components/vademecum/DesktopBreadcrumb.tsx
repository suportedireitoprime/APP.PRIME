    ...
    >
      <ol className="mx-auto flex min-h-[52px] max-w-7xl items-center gap-2 px-8 xl:px-12 py-3 text-[13px] xl:text-sm font-body">
        <li>
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-1 rounded-md p-1 -m-1 text-muted-foreground hover:text-primary transition-colors"
          >
            <Home className="w-4 h-4 xl:w-[18px] xl:h-[18px]" />
