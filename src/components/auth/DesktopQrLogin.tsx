  ...
  return (
    <div className="w-full max-w-md flex flex-col items-center text-center">
      ...
      <p className="mt-2 font-body text-xs xl:text-sm text-white/70 leading-relaxed max-w-sm">
        Abra o app <span className="text-primary font-semibold">Direito Prime</span> no celular
      ...
      >
        <div className="relative w-[min(240px,24vh)] h-[min(240px,24vh)] flex items-center justify-center rounded-2xl bg-primary/95 overflow-hidden">
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center gap-2 text-primary-foreground px-4">
              <AlertTriangle className="w-10 h-10" />
      ...
      {(status === 'expired' || status === 'error') && (
        <button
          onClick={generate}
          className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-primary-foreground font-display font-bold text-sm hover:bg-primary/90 transition-colors"
        >
