      ...
      .then((r) => {
        ...
        setArtigos(
          (r || [])
            ...
            .filter((a: any) => /^(art|§|parágrafo|\d)/i.test(a.numero.trim()))
        );
      })
        ...
        {lei && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 z-[81] flex h-[90dvh] flex-col rounded-t-3xl border-t border-border bg-background pb-[calc(0.5rem+var(--sai-bottom))]"
            >
        ...
        {artigoSelecionado && (
          <>
            ...
            <motion.div
              ...
              exit={{ y: "100%" }}
              transition={{ duration: 0.28, ease: [0.22, 0.61, 0.36, 1] }}
              className="fixed bottom-0 left-0 right-0 z-[91] rounded-t-3xl border-t border-border bg-background pb-[calc(1.25rem+var(--sai-bottom))] px-5 pt-4"
            >
