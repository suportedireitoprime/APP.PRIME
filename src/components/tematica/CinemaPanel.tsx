...
const CinemaPanel = ({ children }: Props) => {
  ...
  return (
    <section
      ...
      style={{
        background:
          'linear-gradient(135deg, hsl(00 55% 14%) 0%, hsl(0 65% 26%) 50%, hsl(05 70% 18%) 100%)',
      }}
    >
      {/* Texturas cinema */}
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[hsl(05,70%,14%)] via-[hsl(05,70%,14%)]/70 to-transparent" />
