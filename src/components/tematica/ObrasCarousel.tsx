    ...
    <section className="mt-7">
      <div className="px-4 mb-3 flex items-end justify-between gap-3">
        ...
        {onVerTodos && (
          <button
            onClick={onVerTodos}
            className="shrink-0 flex items-center gap-1 h-8 px-3 rounded-full bg-card border border-border text-[12px] font-semibold text-foreground/80 hover:text-foreground hover:border-primary/40 transition-colors"
          >
            Ver todos
