...
const LeitorNativo = ({ livroId, livroTabela, pdfUrl, titulo, onClose, autor, ano, editora, sobre, curiosidades, capa }: Props) => {
  ...
  // Livros de "Áreas do Direito" seguem o estilo do artigo do blog: sempre alinhado à esquerda.
  ...
  // Sincroniza progresso salvo na conta antes de restaurar a posição
  useEffect(() => {
