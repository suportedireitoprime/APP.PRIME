...
const ESTILOS_BASE: EstiloBase[] = [
  { id: 'noite', label: 'Noite', bg: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #312e81 100%)', fg: '#F8FAFC', accent: '#F87171' },
  { id: 'sepia', label: 'Sépia', bg: 'linear-gradient(135deg, #3E2A1F 0%, #6B4423 50%, #8B5A2B 100%)', fg: '#FBF5E9', accent: '#F5C77E' },
  { id: 'esmeralda', label: 'Esmeralda', bg: 'linear-gradient(135deg, #022c22 0%, #064e3b 50%, #065f46 100%)', fg: '#ECFDF5', accent: 'hsl(348 78% 38%)' },
  { id: 'papel', label: 'Papel', bg: 'linear-gradient(135deg, #FBF3E0 0%, #F2E4C0 100%)', fg: '#3B2A1A', accent: '#8B5E34' },
  { id: 'rosa', label: 'Aurora', bg: 'linear-gradient(135deg, #4C1D95 0%, #831843 50%, #9F1239 100%)', fg: '#FDF2F8', accent: '#F87171' },
  { id: 'noir', label: 'Noir', bg: 'linear-gradient(180deg, #0a0a0a 0%, #171717 100%)', fg: '#F5F5F5', accent: '#DC2626' },
  { id: 'oceano', label: 'Oceano', bg: 'linear-gradient(160deg, #082f49 0%, #0c4a6e 50%, #155e75 100%)', fg: '#F0F9FF', accent: '#7DD3FC' },
  { id: 'terra', label: 'Terra', bg: 'linear-gradient(160deg, #1c1917 0%, #44403c 50%, #78716c 100%)', fg: '#FAFAF9', accent: '#DC2626' },
  { id: 'direito', label: 'Direito', bg: 'linear-gradient(135deg, #1e293b 0%, #0f172a 100%)', bgOverlay: patternDireito, fg: '#F8FAFC', accent: '#F87171' },
  { id: 'classico', label: 'Clássico', bg: 'linear-gradient(135deg, #292524 0%, #1c1917 100%)', bgOverlay: patternClassico, fg: '#FEF3C7', accent: '#DC2626' },
  { id: 'capa', label: 'Capa', bg: '#111827', fg: '#F9FAFB', accent: '#F87171', usaCapa: true },
  { id: 'capa-blur', label: 'Capa desfocada', bg: '#0a0a0a', fg: '#F9FAFB', accent: '#F87171', usaCapa: true },
];
