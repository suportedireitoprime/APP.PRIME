...
export const CADASTRO_SCRIPT: NarracaoScene[] = [
  { id: 'abertura', startFrame: 0, text: 'Bem-vindo ao Direito Prime. Direito, do seu jeito.' },
  ...
  { id: 'encerramento', startFrame: 745, text: 'Pronto! Seu Direito Prime já está personalizado. Bora estudar.' },
];
