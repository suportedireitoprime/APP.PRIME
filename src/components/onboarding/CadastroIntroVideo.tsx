      ...
      <div style={{ textAlign: 'center', transform: `scale(${scale})`, opacity: s }}>
        <div
          style={{
            ...
            textShadow: `0 0 60px rgba(239,68,68,0.35)`,
          }}
        >
          Direito Prime
        </div>
          ...
          return (
            <div
              ...
              style={{
                padding: '22px 40px',
                borderRadius: 100,
                border: `2px solid rgba(239,68,68,${0.3 + t * 0.4})`,
                background: `rgba(239,68,68,${0.05 + t * 0.08})`,
                color: CREAM,
                fontFamily: bodyFont,
                fontSize: 34,
                fontWeight: 600,
  ...
  return (
    <AbsoluteFill style={{ alignItems: 'center', justifyContent: 'center', padding: 80 }}>
      ...
      <div style={{ textAlign: 'center', opacity: s, transform: `translateY(${(1 - s) * 40}px)` }}>
        ...
        >
          Tudo pronto. Seu Direito Prime já está personalizado.
        </div>
      </div>
    </AbsoluteFill>
  );
