...
export default function TriagemVersaoB({ open, onFinished }: Props) {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          'radial-gradient(circle at 50% 0%, rgba(239,68,68,0.18), transparent 45%), #05050A',
      }}
    >
      {/* Header */}
      <div
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F5C518] to-[#C94C4C] flex items-center justify-center text-black font-black text-lg">
            H
          </div>
          <div>
