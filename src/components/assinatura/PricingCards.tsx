...
export function PricingCards({ selectedPlan, isNewUser, onSelectPlan }: PricingCardsProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-6 px-4 pt-2 pb-6">
      ...
      <div className="flex p-1 bg-card/60 rounded-full border border-border/50 relative z-20 shadow-inner max-w-sm mx-auto w-full">
        <button
          ...
          className={`relative z-10 flex-1 py-3 text-[11px] sm:text-xs font-bold uppercase tracking-wider rounded-full transition-all duration-300 ${
            activePlan === 'mensal' 
              ? 'text-foreground' 
        ...
        >
          {activePlan === 'promocao' && isNewUser && (
            <button
              ...
              className="relative w-full rounded-3xl border-2 transition-all duration-300 text-left p-5 overflow-hidden border-emerald-500 bg-emerald-500/10 shadow-[0_0_40px_rgba(16,185,129,0.15)] ring-1 ring-emerald-500/50"
            >
          ...
          {activePlan === 'anual' && (
            <button
              ...
              className="relative w-full rounded-3xl border-2 transition-all duration-300 text-left p-5 overflow-hidden border-primary bg-primary/5 shadow-[0_0_40px_rgba(224,31,71,0.15)] ring-1 ring-primary/50"
            >
          ...
          {activePlan === 'mensal' && (
            <button
              type="button"
              onClick={() => onSelectPlan('mensal')}
              className="relative w-full rounded-3xl border-2 transition-all duration-300 text-left p-5 overflow-hidden border-border bg-card shadow-lg ring-1 ring-border/50"
            >
