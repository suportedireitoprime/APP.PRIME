      ...
      >
        <div className="mx-auto max-w-lg rounded-t-3xl overflow-hidden bg-background/95 backdrop-blur-xl border border-white/10">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, hsl(0 95% 55% / 0.18) 0%, hsl(0 95% 55% / 0.04) 100%)',
            }}
          >
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, hsl(0 95% 55% / 0.25) 0%, hsl(0 95% 50% / 0.1) 100%)',
                boxShadow: '0 12px 32px -8px hsl(0 95% 55% / 0.55)',
              }}
            >
              <img
                src={srcOf(horusOwl)}
          ...
          <div className="px-6 py-5 space-y-3">
            ...
            <div className="flex flex-col gap-2 pt-1">
              <Button
                ...
                style={{
                  background: 'linear-gradient(135deg, hsl(0 95% 55%) 0%, hsl(0 95% 50%) 100%)',
                  boxShadow: '0 8px 20px -6px hsl(0 95% 55% / 0.5)',
                }}
              >
