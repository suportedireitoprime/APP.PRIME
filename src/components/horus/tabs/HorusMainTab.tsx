...
export function HorusMainTab({
  ...
  handleWhatsAppClick, onRequestVerify, onCallClick
}: HorusMainTabProps) {
  return (
    <motion.div
      key="main"
    ...
    >
      ...
      <div className="px-5 pb-6 flex flex-col gap-6">
        ...
        <motion.button
          ...
          className="mx-auto w-full max-w-sm h-12 rounded-full border border-white/10 bg-white/5 active:scale-[0.98] transition-all flex items-center justify-center gap-2.5 hover:bg-white/10"
        >
          <div className="w-6 h-6 rounded-full bg-white/10 flex items-center justify-center">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5 text-white/80">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
            </svg>
          </div>
          <span className="font-display text-[14px] font-bold text-white/90 uppercase tracking-widest">Ligar para o Horus</span>
        </motion.button>
