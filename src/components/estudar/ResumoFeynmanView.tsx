...
const FeynmanPdfDoc = ({ data }: { data: FeynmanData }) => (
  <Document>
    <Page size="A4" style={pdfStyles.page}>
      ...
      <Text style={pdfStyles.subtitle}>Resumo Feynman — Direito Prime 2026</Text>
      ...
      <Text style={pdfStyles.footer} render={({ pageNumber, totalPages }) => `Direito Prime — Resumo Feynman — Página ${pageNumber} de ${totalPages}`} fixed />
    </Page>
  </Document>
);
