...
const QuizView = ({ tabelaNome, artigoNumero, leiNome, onBack }: Props) => {
  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <div className="max-w-2xl lg:max-w-[1100px] mx-auto px-4 sm:px-6 py-6 lg:px-10 lg:py-10">
        {/* Painel histórico */}
        <AnimatePresence>
          {showHistory && (
            <motion.div
        ...
        {loading ? null : error ? (
          ...
          <>
            ...
            {answered && (
              <Button onClick={next} className="w-full mt-4 lg:mx-auto lg:w-auto lg:min-w-[240px] lg:block">
