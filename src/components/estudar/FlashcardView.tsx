...
const FlashcardView = ({ tabelaNome, artigoNumero, leiNome, onBack }: Props) => {
  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <div className="max-w-2xl lg:max-w-[1000px] mx-auto px-4 sm:px-6 py-6 lg:px-10 lg:py-10">
        ...
        {loading ? null : error ? (
          ...
          <>
            ...
            {/* Flip card */}
            <div
              className="relative w-full h-[420px] lg:h-[520px] cursor-pointer select-none"
            ...
            {/* Nav */}
            <div className="flex items-center justify-between mt-6 gap-3 lg:mx-auto lg:max-w-md">
