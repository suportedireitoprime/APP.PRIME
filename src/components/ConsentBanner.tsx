...
/**
 * Banner de consentimento LGPD alinhado ao design system Direito Prime.
        ...
        <div className="p-3">
          <div className="flex items-start gap-2.5 text-left">
            <div
              ...
              style={{ background: "radial-gradient(circle at 30% 30%, hsl(0 100% 50% / 0.22), transparent 70%)" }}
              aria-hidden
            >
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[12px] font-serif font-semibold tracking-tight text-primary-foreground/95 leading-tight"
                 style={{ color: "hsl(0 15% 92%)" }}>
                Sua privacidade, nosso compromisso.
              </p>
              <p className="mt-1 text-[11px] leading-relaxed text-white/60">
                Dados anônimos (Google Analytics) para melhorar o Direito Prime. Nada vinculado à sua identidade sem permissão.
              </p>
            </div>
          </div>
          ...
          <div className="mt-2.5 flex items-center justify-end gap-2">
            ...
            <button
              type="button"
              onClick={accept}
              className="relative overflow-hidden px-3 py-1.5 text-[11px] font-bold rounded-md text-black active:scale-[0.97] transition-all shadow-[0_6px_18px_-6px_hsl(0_100%_50%/0.6)] hover:shadow-[0_8px_22px_-5px_hsl(0_100%_50%/0.8)] group"
              style={{
                background:
                  "linear-gradient(135deg, hsl(0 100% 62%) 0%, hsl(0 100% 50%) 55%, hsl(0 95% 45%) 100%)",
              }}
            >
