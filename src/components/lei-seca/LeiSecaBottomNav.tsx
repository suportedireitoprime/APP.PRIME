...
const LeiSecaBottomNav = ({ hidden = false }: { hidden?: boolean }) => {
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 z-50  md:bottom-4 md:left-1/2 md:right-auto md:-translate-x-1/2 md:w-auto pointer-events-auto"
    >
      <div className="bg-card/95 backdrop-blur-md border-t border-border rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.6),0_-2px_10px_rgba(0,0,0,0.4)] pb-safe md:border md:rounded-full md:shadow-2xl md:shadow-black/30 md:pb-0">
