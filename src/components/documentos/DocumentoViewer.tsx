...
const DocumentoViewer = ({ blob, nome, mime, onClose, onBaixar, baixando }: Props) => {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[95] flex flex-col bg-background">
      <div className="flex items-start gap-3 border-b border-border/60 px-3 pt-[calc(1.25rem+var(--sai-top))] pb-3">
        <button
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain bg-muted/30 px-3 pt-3 pb-[calc(4rem+var(--safe-bottom))]">
