                ...
                return (
                  ...
                  >
                    <motion.button
                      ...
                      style={{
                        boxShadow: dominado
                          ? '0 10px 24px rgba(239,68,68,0.45), 0 4px 8px rgba(0,0,0,0.3), inset 0 -4px 0 rgba(0,0,0,0.22), inset 0 2px 0 rgba(255,255,255,0.35)'
                        ...
                        <span className="absolute -top-3 left-1/2 -translate-x-1/2 flex items-center gap-0.5 px-1.5 py-0.5 rounded-full bg-black/70 backdrop-blur-sm">
                          {[1, 2, 3].map((n) => (
                            <span
                              ...
                              style={{ color: n <= (prog.estrelas ?? 0) ? '#c2274a' : 'rgba(255,255,255,0.25)' }}
                            >
                              ★
                            </span>
                          ))}
