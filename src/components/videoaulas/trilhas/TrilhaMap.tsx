...
import { ChevronLeft, Settings2, CheckCircle2, Lightbulb, PlayCircle } from 'lucide-react';
...
export const TrilhaMap = ({ concursos, onBack }: TrilhaMapProps) => {
      ...
      <div className="sticky top-0 z-40 bg-background/95 border-b border-white/5 px-4 py-4 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          <button
            onClick={onBack}
            aria-label="Voltar"
            className="p-2 -ml-2 rounded-full bg-white/5 text-muted-foreground hover:text-foreground"
          >
