  ...
  return (
    <div className="w-full space-y-6 select-none">
        ...
        <div className="relative flex items-center justify-center w-full max-w-full h-[330px] sm:h-[390px] md:h-[420px] overflow-visible">
          ...
          {ativo > 0 && (
            <button
              ...
              className="absolute left-1 sm:left-4 md:left-8 z-40 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-black/65 hover:bg-black/90 active:scale-95 border border-white/20 text-white shadow-2xl backdrop-blur-md flex items-center justify-center transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-rose-500"
            >
              <ChevronLeft className="w-6 h-6 sm:w-7 sm:h-7 stroke-[2.4]" />
            </button>
          )}
          ...
          {ativo < total - 1 && (
            <button
              ...
              className="absolute right-1 sm:right-4 md:right-8 z-40 w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-black/65 hover:bg-black/90 active:scale-95 border border-white/20 text-white shadow-2xl backdrop-blur-md flex items-center justify-center transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-rose-500"
            >
              <ChevronRight className="w-6 h-6 sm:w-7 sm:h-7 stroke-[2.4]" />
            </button>
          )}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="my-auto py-2 text-center relative z-10 px-1 flex flex-col items-center">
                      {frente ? (
      ...
      <div className="w-full max-w-xl mx-auto space-y-3 pt-2">
        ...
        {timelineRecentes.length > 0 ? (
          <div className="relative border-l-2 border-white/15 ml-4 sm:ml-5 pl-4 sm:pl-5 space-y-3">
            {timelineRecentes.map((aula, idx) => {
              ...
              return (
                <div key={aula.aulaId} className="relative group">
                  ...
                  <div
                    className={cn(
                      "absolute -left-[23px] sm:-left-[27px] top-3.5 w-6 h-6 rounded-full border-2 flex items-center justify-center shadow-lg transition-transform group-hover:scale-110",
                    ...
                    style={{
                      ...
                      boxShadow: isFirst ? `0 0 10px ${pal.primary}` : undefined,
                    }}
                  >
                    {aula.pct === 100 ? (
                  ...
                  <div
                    ...
                    className="p-3.5 rounded-xl bg-card/70 hover:bg-card border border-white/10 hover:border-white/20 transition-all cursor-pointer shadow-md flex flex-col gap-2 relative overflow-hidden"
                  >
                    <div className="flex items-center justify-between gap-2">
                      <span
                        className="text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-md text-white border"
                        style={{
                          backgroundColor: `${pal.primary}25`,
                    ...
                    <h5 className="text-xs sm:text-sm font-semibold text-white group-hover:text-rose-400 transition-colors line-clamp-2">
                      {aula.titulo}
                    </h5>
