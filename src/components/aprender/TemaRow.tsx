...
const TemaRow = ({ numero, titulo, totalAulas, emPreparo, pct, onClick }: Props) => {
  return (
    ...
    >
      <div
        className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full font-display text-[15px] font-black tabular-nums text-primary-foreground sm:h-12 sm:w-12 sm:text-base"
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 h-1 w-full overflow-hidden rounded-full bg-muted">
          <div
            ...
            style={{ width: `${Math.max(0, Math.min(100, pct))}%`, background: 'hsl(348 78% 38%)' }}
          />
        </div>
      </div>
