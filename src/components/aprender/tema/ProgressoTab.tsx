    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex min-w-0 flex-1 flex-col justify-center gap-2 text-black">
          ...
          <div
            className="inline-flex w-fit items-center gap-1.5 rounded-full bg-black/85 px-3 py-1.5 text-[12px] font-bold uppercase tracking-wider text-[hsl(0_72%_52%)]"
            style={{ fontFamily: "'Barlow', system-ui, sans-serif" }}
          >
      ...
      <div className="rounded-2xl border border-border bg-card p-4">
        ...
        <div className="h-2 w-full overflow-hidden rounded-full bg-muted">
          <div
            ...
            style={{ width: `${pct}%`, background: 'hsl(348 78% 38%)' }}
          />
        </div>
        <p
