/**
 * Screen tracking — screen_view, screen_exit, scroll depth.
 * Web: GA4 (gtag) + Meta. Nativo: Firebase Analytics (screen_view + setCurrentScreen).
 */
...
export function useScreenTracking() {
  ...
  // screen_view em todas as plataformas (web + app nativo).
  useEffect(() => {
