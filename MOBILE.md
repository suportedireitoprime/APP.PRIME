...
2. **Google Cloud/Firebase — OAuth Android**
   ...
   - Package name obrigatório: `br.com.direitoprime.app`.
...
O workflow Android valida automaticamente se o `google-services.json` tem OAuth Web, OAuth Android para `br.com.direitoprime.app`, e se o SHA-1 da chave de release está cadastrado.
...
2. Adicionar app Android com o `applicationId` `br.com.direitoprime.app`
