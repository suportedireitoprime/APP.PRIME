...
DO $$ BEGIN
    CREATE POLICY "Decks are viewable by everyone" ON public.pilulas_decks FOR SELECT USING (true);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

DO $$ BEGIN
    CREATE POLICY "Cards are viewable by everyone" ON public.pilulas_cards FOR SELECT USING (true);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
